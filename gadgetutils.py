...
def writedir(
    ...
    folder = 'bx' + str(int(boxsize)) + uscr + 'ng' + str(ngrid) + uscr + \
    ...
    if ((scheme == '2lpt') or (scheme == 'zeld') or (
            scheme == 'muscle') or (scheme == 'sc')):
        fileroot_out = extra_info + 'z' + str(int(redshift)) + '__0'

    # in alpt save sigmaalpt
    elif (smallscheme == 'sc'):
        fileroot_out = extra_info + 'z' + \
            str(int(redshift)) + 'sigmaalpt' + '{0:.1f}'.format(sigmaalpt) + '__0'
